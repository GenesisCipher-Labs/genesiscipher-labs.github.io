---
title: Pact Terms of Use
permalink: /pact/terms/
---
...
- Everything you put into Pact stays **on your device**. We operate no server that receives your profile, brands, deals, invoices, or payments, and we do not sell or share your data.
- Deal text you paste or share is processed on your device (using Apple Intelligence where available, or an offline parser) and is never sent to us or any third-party AI service.
- See the [Pact Privacy Policy](/pact/privacy/) for the full detail, including your rights under India's DPDP Act.
...
- You can **manage or cancel** your subscription any time in your Apple Account settings (Settings → your name → Subscriptions). Uninstalling the app does not cancel a subscription.
- Current prices are shown in the app before you buy and may vary by region; we may change prices for future periods with notice as required.
- Purchases, billing, and refunds are handled by Apple under Apple's terms; we do not process or store your payment details.

## Acceptable use

Use Pact only for lawful invoicing and record-keeping for your own business. Do not attempt to reverse-engineer, disrupt, or misuse the app.

## Changes and governing law

We may update these terms and will revise the "Last updated" date. These terms are governed by the laws of India.

## Contact

GenesisCipher Labs — **genesiscipherlabs@gmail.com**

*These terms describe how Pact works and are provided in good faith. They should be reviewed by qualified counsel before publication in your specific jurisdiction.*
