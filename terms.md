...
- Within current Canada coverage, surfaces 911 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
- Within current United Kingdom coverage, surfaces 999 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
- Within current France coverage, surfaces 112 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
- Within current Spain coverage, surfaces 112 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
- Within current Germany coverage, surfaces 112 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
- Within current Netherlands coverage, surfaces 112 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
- Within current Italy coverage, surfaces 112 as a user-initiated emergency dial action. HomeSafe does not call or dispatch on your behalf.
