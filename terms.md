...
This version covers the supported United States cities only: routing, search, place reads, Help directories and the companion surfaces are limited to them. Other bundled city data stays on your device unchanged, and any history you already hold is untouched.
